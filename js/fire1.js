...
class Battery
{
    constructor(fireworks) {
        ...
        this._shot = salve => {
            ...
            this.fireworks.engine.font = "50px Arial Black";
            this.fireworks.engine.fillStyle = '#B76CF0'
            this.fireworks.engine.fillText('З Днем', 80, 230)
            this.fireworks.engine.fillText('Народження', 40, 300)
            this.fireworks.engine.fillText('Свєта!!!', 80, 370)
